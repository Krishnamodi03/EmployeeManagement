	...
	<div class="container">
		...
		<form action="register" method="post">
			...
			<br> Gender : <input type="radio" id="male" name="gender"
				...
				id="other" name="gender" value="other">Others<br>
			<br> Hobbies: <input type="checkbox" id="reading" name="hobbies"
				value="Reading">Reading <input type="checkbox"
				id="traveling" name="hobbies" value="Traveling">Traveling <input
				type="checkbox" id="sports" name="hobbies" value="Sports">Sports<br>
